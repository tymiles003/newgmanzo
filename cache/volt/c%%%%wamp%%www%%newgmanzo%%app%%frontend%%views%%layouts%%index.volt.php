        ...
        <div id="content" class="col-xs-12">
          ...
          <?php foreach ($products as $keys => $values) { ?>
            <div class="product-thumb clearfix" id="item<?= $keys + 1 ?>">
              <div class="image">
                <a href="<?= $this->url->get('store/details/' . $values['product_id']) ?>"><img  src="<?= $this->url->get('assets/uploads/' . $values['front_image']) ?>" class="img-responsive" /></a>
              </div>
              <div class="caption">
                <h4><a href="<?= $this->url->get('details/') ?>"><a href="detail.html" style="color:#333;"><?= ucwords($values['title']) ?></a></a></h4>
          ...
          <div class="category-module" id="latest_category">
            ...
            <div class="category-module-content">
              ...
              <?php foreach ($available as $keys => $values) { ?>
                <li><a href="#tab-cat<?= $keys + 1 ?>"><?= ucwords($values['category_name']) ?></a></li>
              <?php } ?>
              </ul>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <img src="<?= $this->url->get('assets/images/logo.png') ?>" alt="">
